...
class ImageCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setSearchFields(['id', 'filename', 'resizedFilename', 'thumbnailFilename', 'description', 'longDescription', 'exifData.latitude', 'exifData.longitude', 'exifData.altitude', 'exifData.make', 'exifData.model', 'exifData.exposure', 'exifData.aperture', 'exifData.focalLength', 'exifData.ISO', 'exifData.gpsImgDirection', 'exifData.gpsLatitudeRef', 'exifData.gpsLongitudeRef', 'exifData.focalLengthIn35mmFilm', 'weather.description', 'weather.temperature', 'weather.humidity', 'weather.pressure', 'weather.windSpeed'])
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        $exifDataGpsImgDirection = TextField::new('exifData.gpsImgDirection');
        $exifDataGpsLatitudeRef = TextField::new('exifData.gpsLatitudeRef');
        $exifDataGpsLongitudeRef = TextField::new('exifData.gpsLongitudeRef');
        $exifDataFocalLengthIn35mmFilm = TextField::new('exifData.focalLengthIn35mmFilm');
        ...
        if (Crud::PAGE_INDEX === $pageName) {
            ...
            return [$id, $filename, $resizedFilename, $thumbnailFilename, $description, $longDescription, $createdAt, $exifDataLatitude, $exifDataLongitude, $exifDataAltitude, $exifDataMake, $exifDataModel, $exifDataExposure, $exifDataAperture, $exifDataFocalLength, $exifDataISO, $exifDataTakenAt, $exifDataGpsImgDirection, $exifDataGpsLatitudeRef, $exifDataGpsLongitudeRef, $exifDataFocalLengthIn35mmFilm, $weatherDescription, $weatherTemperature, $weatherHumidity, $weatherPressure, $weatherWindSpeed, $gallery];
